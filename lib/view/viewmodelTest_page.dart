...
final vmProvider =
    StateNotifierProvider<vmNotifier, GroupViewModel>((ref) => vmNotifier());
...
final vmProvider3 = FutureProvider<List<Settlement>>((ref) async {
  final GroupViewModel vm =
      GroupViewModel("88f8433b-0af1-44be-95be-608316118fad");
...
class vmNotifier extends StateNotifier<GroupViewModel> {
  ...
  vmNotifier()
      : super(GroupViewModel("88f8433b-0af1-44be-95be-608316118fad")); //엄우네아

  void merge() async {
    state.mergeSettlement(
        state.settlementInGroup[0], state.settlementInGroup[1], "합쳐진 새로운 정산");
  }
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        if (gvm.settlementInGroup[index].isMerged == false) {
                          return ListTile(
                            title: Text(
                              "정산 ${index + 1}: ${gvm.settlementInGroup[index].settlementName}",
